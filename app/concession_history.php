...
class concession_history extends Model
{
    //
    protected $table = 'concession_history';

    protected $fillable = ['history_id', 'company_id', 'concession_name', 'equity_1', 'percentage_1', 'equity_2', 'percentage_2', 'equity_3', 'percentage_3', 'equity_4', 'percentage_4', 'equity_5', 'percentage_5', 'equity_6', 'percentage_6', 'equity_7', 'percentage_7', 'equity_8', 'percentage_8', 'contract_id', 'award_date', 'license_expire_date', 'area', 'geological_terrain_id', 'comment', 'status', 'created_by', 'updated_by'];
