...
class Bala_opl extends Model
{
    //
    protected $table = 'Bala_opl';

    protected $fillable = ['company_id', 'stage_id', 'concession_held_id', 'equity_distribution', 'contract_type', 'year_of_award', 'license_expire_date', 'area', 'geological_terrain_id', 'comment', 'year', 'created_by'];
    ...
    // public function up_concession_terrain(){
        //     return $this->belongsTo('App\up_concession_terrain','geological_terrain_id');
        // }
}
