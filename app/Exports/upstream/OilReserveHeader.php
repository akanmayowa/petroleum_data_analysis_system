...
class OilReserveHeader implements WithTitle, WithHeadings
{
    /**
    ...
    {
        $table = collect($this->getTableColumns('up_reserves_oil'))->filter(function ($value) 
        {
