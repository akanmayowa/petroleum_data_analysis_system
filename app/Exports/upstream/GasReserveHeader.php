...
class GasReserveHeader implements WithTitle, WithHeadings
{
    /**
    ...
    {
        $table = collect($this->getTableColumns('up_reserves_gas'))->filter(function ($value) 
        {
