...
class RefinedCrudeProcessedHeader implements WithTitle, WithHeadings
{
    /**
    ...
    {
        $table = collect($this->getTableColumns('down_refinary_capacity_utilization'))->filter(function ($value) 
        {
    ...
    {
        return 'Refined Crude Processed';  
    }
