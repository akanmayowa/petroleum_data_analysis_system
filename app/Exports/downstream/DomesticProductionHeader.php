...
class DomesticProductionHeader implements WithTitle, WithHeadings
{
    /**
    ...
    {
        $table = collect($this->getTableColumns('down_refinery_production_volumes'))->filter(function ($value) 
        {
