 ...
 implements WithTitle, WithHeadings
{
    ...
    {
        $table = collect($this->getTableColumns('down_petrochemical_plant_project'))->filter(function ($value) 
        {
    ...
    {
        return 'Petrochemical Plant Projects';  
    }
