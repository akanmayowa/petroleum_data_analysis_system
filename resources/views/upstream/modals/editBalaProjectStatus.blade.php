<form id="upMultiClientForm" action="{{url('/upstream')}}" method="POST">
          @php 
          ...
          <div class="form-group row">
            <label for="year_pse" class="col-sm-2 col-form-label"> Year </label>
            <div class="col-sm-10">
                <input type="text" class="form-control" placeholder="Year" name="year" id="year_pse" value="{{$PRO_STA_->year}}" required readonly>
            </div>
          </div>
          ...
          <div class="form-group row">
            ...
            <div class="col-sm-10">
                <input type="text" class="form-control" placeholder="Survey Name" name="survey_name" id="survey_name" value="{{$PRO_STA_->survey_name}}" required>
            </div>
          </div>
          ...
          <div class="form-group row">
            ...
            <div class="col-sm-10">
                <input type="text" class="form-control" name="quantum_of_survey" id="quantum_of_survey" value="{{$PRO_STA_->quantum_of_survey}}" required>
            </div>
          </div>
          ...
          <div class="modal-footer">
            ...
            <button type="submit" name="" id="" class="btn btn-dark" onclick="return confirm('Are you sure you want to UPDATE Details?')"> <i class="fa fa-check"></i> Update Multi-Client Projects </button>
          </div>
</form>
...
<script>    
    ...
    $(function()
    {    
        $("#upMultiClientForm").on('submit', function(e)
        {   
            e.preventDefault();            
            editForm('upMultiClientForm', "{{url('/upstream')}}", 'editbala_data_ps');
