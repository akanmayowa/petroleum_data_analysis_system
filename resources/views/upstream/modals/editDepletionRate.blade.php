...
<form id="upDeplRateForm" action="{{url('/upstream')}}" method="POST">
      ...
      <div class="form-group row">
        <label for="prev_oil_condensate" class="col-sm-2 col-form-label">Prev Oil + Reserves(MMbbls) </label>
        <div class="col-sm-10">
            <input type="number" step="0.01" class="form-control rese" name="prev_oil_condensate" id="prev_oil_condensate" onkeyup="checktotal(this)" value="{{$RESERVE_->prev_oil_condensate}}" required>
        </div>
      </div> 
     

      <div class="form-group row">
        <label for="curr_oil_condensate" class="col-sm-2 col-form-label">Curr Oil + Reserves(MMbbls) </label>
        <div class="col-sm-10">
            <input type="number" step="0.01" class="form-control rese" name="curr_oil_condensate" id="curr_oil_condensate" onkeyup="checktotal(this)" value="{{$RESERVE_->curr_oil_condensate}}" required>
        </div>
      </div> 
