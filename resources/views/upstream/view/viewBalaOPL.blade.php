...
<form id="" action="{{url('/bala/add_bala_opl')}}" method="POST">
          ...
          <div class="form-group row">
            <label for="year_op" class="col-sm-2 col-form-label"> Year </label>
            <div class="col-sm-4">
                <input type="text" class="form-control" placeholder="Year YYYY" name="year" id="year_op" value="{{$OPL->year}}" required readonly>
            </div>
