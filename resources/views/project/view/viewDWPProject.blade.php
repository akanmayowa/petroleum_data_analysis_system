...
<form id="" action="{{url('/project/addproject')}}" method="POST">
            {{ csrf_field() }}
            <input type="hidden" class="form-control" id="id" name="id" value="{{$Project->id}}" required>

            <?php 
                $alignment_ = \App\alignment::where('id', $Project->alignment_id)->first();
                $one_pp = \App\dwp_program_priority::where('id', $Project->dpr_work_plan)->first();
                $one_tt = \App\dwp_task_target::where('id', $Project->task_and_target)->first();
                $division_ = \App\division::where('id', $Project->division_id)->first();
                $one_cms = \App\dwp_critical_milestone::where('id', $Project->critical_milestone_id)->first();
                $one_tim = \App\dwp_timeline::where('id', $Project->timeline_id)->first();
                $one_ach = \App\dwp_achievement_status::where('id', $Project->achievement_status_id)->first();
                $one_fac = \App\dwp_restricting_factor::where('id', $Project->restricting_factor_id)->first();
                $one_kpi = \App\dwp_kpi_target::where('id', $Project->kpi_target_id)->first();
                $one_pla = \App\dwp_key_recovery_plan::where('id', $Project->key_recovery_plan_id)->first();
            ?>
          ...
          <div class="form-group row">
            ...
            <div class="col-sm-4">
                <input type="text" class="form-control" placeholder="Month Of Project" name="month" id="month_dwpe" value="{{$Project->month}}" disabled="">
            </div>

            <label for="year_dwpe" class="col-sm-2 col-form-label"> Year </label>
            <div class="col-sm-4">
                <input type="text" class="form-control" placeholder="Year Of Project" name="year" id="year_dwpe" value="{{$Project->year}}" disabled>
            </div>
          </div>
          ...
          <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <select class="form-control" name="alignment_id" id="alignment_id"  disabled>
          ...
          <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <select class="form-control" name="dpr_work_plan" id="dpr_work_plan"  disabled>
                        @if($one_pp) <option value="{{$one_pp->dpr_work_plan}}"> {{$one_pp->program_priority_name}} </option> @endif
                    </select>
                </div>
          </div>
          ...
          <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <select class="form-control" name="task_and_target" id="task_and_target"  disabled>
                        @if($one_tt) <option value="{{$one_tt->task_and_target}}"> {{$one_tt->task_target_name}} </option> @endif
                    </select>
                </div>
          </div>
          ...
          <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <select class="form-control" name="kpi_target_id" id="kpi_target_id"  disabled>
                        @if($one_kpi) <option value="{{$one_kpi->task_and_target}}"> {{$one_kpi->kpi_name}} </option> @endif
                    </select>
                </div>
          </div>
          ...
          <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <select class="form-control" name="critical_milestone_id" id="critical_milestone_id"  disabled>
          ...
          <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <select class="form-control" name="timeline_id" id="timeline_id"  disabled>
          ...
          <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <select class="form-control" name="achievement_status_id" id="achievement_status_id"  disabled>
          ...
          <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <select class="form-control" name="division_id" id="division_id"  disabled>
          ...
          <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <select class="form-control" name="program_priority_id" id="program_priority_id"  disabled>
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <select class="form-control" name="critical_path_activity" id="critical_path_activity"  disabled>
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <select class="form-control" name="restricting_factor_id" id="restricting_factor_id"  disabled>
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <input type="text" class="form-control" placeholder="Cost Benefit Factor" name="cost_benefit_factor" id="cost_benefit_factor" value="{{$Project->cost_benefit_factor}}" disabled>
                </div>
            </div>
          ...
          <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <select class="form-control" name="key_recovery_plan_id" id="key_recovery_plan_id"  disabled>
                    ...
                    <tr>
                        <td width="33%">
                            ...
                            <input type="radio" class="form-control" id="ad_spe" name="monitored_by" 
                                ...
                                style="width: 1.6em; height: 1.5em; margin-top: 3px; border: 1px;" value="Assistant Director-S&PE" disabled> 
                        </td>
                        <td width="33%">
                            ...
                            <input type="radio" class="form-control" id="hp" name="monitored_by" 
                                ...
                                style="width: 1.6em; height: 1.5em; margin-top: 3px; border: 1px;" value="Head Planning" disabled>
                        </td>
                        <td width="33%">
                            ...
                            <input type="radio" class="form-control" id="director" name="monitored_by" 
                                ...
                                style="width: 1.6em; height: 1.5em; margin-top: 3px; border: 1px;" value="Director" disabled>
                        </td>
                    </tr>
                </table>
            </div>                
        ...
        <div class="col-sm-6 text-muted text-left">
            Uploaded @ {{\Carbon\Carbon::parse($Project->created_at)->diffForHumans()}}
        </div>
