    ...
    <h5 style="margin-left: 5px; color: #aaa"> Field Development Plan 
        ...
        <table class="table table-striped table-sm mb-0" id="fdp_table">
            ...
            <tr>
                ...
                <th>Company</th>
                <th>Field</th>
                <th>Anticipated Production Rate (MMscf/d)</th>
                <th>Expected Reserves (BSCF)</th>
                ...
                @if($field_development_plan)
                    @foreach($field_development_plan as $_field_development_plan)
                        ...
                        <tr>           
                            ...
                            <th>    
                                <a data-toggle="modal" style="cursor: pointer; color:#E32636; font-size:10px" tooltip="true" onclick="deleteRecord('\App\\up_field_development_plan', {{$_field_development_plan->id}})" class="btn-sm pull-right" title="Delete Field Development Plan Gas"> <i class="fa fa-remove"></i>   </a>
