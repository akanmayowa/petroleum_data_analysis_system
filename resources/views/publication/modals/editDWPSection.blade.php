        ...
        <div id="" class="col-md-12" style="border:#e1e1e1 thin solid; border-radius: 6px; border-top-color: #fff"> <hr>
            ...
            <div id="" class="col-md-12" style="padding: 15px 0px">                       
                <div class="modal-footer" id="add_footer">  
                    ...
                    <button type="submit" name="upd_pub_btn" id="upd_pub_btn" class="btn btn-dark" style="font-size: 12px"> <i class="fa fa-check"></i> Update Content </button>
                </div>
            </div>
...
<script>
    ...
    {    
        ...
        $('#addListBtn').on('click', function ()  
        {
            i++;  
            $('#section').append(
            '<div id="row_list'+i+'" class="form-group row">      <label for="list'+i+'" class="col-md-1 col-form-label"> List </label>    <div class="col-md-11">   <table>  <tr>  <th width="100%"><input type="text" class="form-control" placeholder="Publication List '+i+'" name="list'+i+'" id="list'+i+'"></th> <th width="0.5%"> <a class="btn_remove_list" name="remove" id="'+i+'" href="#" title="Remove This List" style="padding:10px">  <i class="fa fa-remove text-inverse m-r-10" style="color:red"></i>    </a> </th>  </tr> </table>       </div>      </div>'
        ...
        $('#addContentBtn').on('click', function ()  
        {
            j++;  
            $('#section').append(
            '<div id="row_content'+j+'" class="form-group row">      <label for="content'+j+'" class="col-md-1 col-form-label"> Content </label>    <div class="col-md-11">   <table>  <tr>  <th width="100%"><textarea rows="2" class="form-control" placeholder="Publication Content '+j+'" name="content'+j+'" id="content'+j+'"></textarea></th> <th width="0.5%"> <a class="btn_remove_content" name="remove" id="'+j+'" href="#" title="Remove This Content" style="padding:10px">  <i class="fa fa-remove text-inverse m-r-10" style="color:red"></i>    </a> </th>  </tr> </table>       </div>      </div>'
