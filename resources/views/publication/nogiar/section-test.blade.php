...
<a href="#" id="convertBtn" onclick="return false" class="btn btn-success btn-xs pull-right no-print" style="margin-left: 5px; margin-right: 25px"> <i class="fa fa-download"></i> </a>
...
{{-- INCLUDING NOGIAR CSS --}}
@include('publication.partials.publicationTableofContentHeader')
        ...
        <div class="card m-b-30">
            <div class="card-body">
                ...
                <div class="row" id="" style="padding: 0px; @if($controllerName->showHideTable($yrs, 6) == 0) display: none; @endif"> 
                    ...
                    <div class="row col-md-12 remark-div" id="bottomTab_6"> 
                ...
                <div class="row" id="" style="padding: 0px; @if($controllerName->showHideTable($yrs, 12) == 0) display: none; @endif">
                    ...
                    <div class="table-responsive">
                        <table class="table table-condensed mb-0" id="" style="-webkit-print-color-adjust: exact!important;">
                            ...
                            <tbody>  @php $i=1; @endphp
                            @php $prod = 0;  $net = 0; $perc = 0; $dep = 0; $life = 0; 
                ...
                <textarea rows="10" class="form-control" name="test_content" id="test_content" style="">
