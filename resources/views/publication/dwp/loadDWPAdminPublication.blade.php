                                    ...
                                    <div class="">
                                        ...
                                        <div class="cd-timeline-content timeline-height"> 
                                            ...
                                            <span class="cd-date"> {{$section->year}}
                                                ...
                                                @if(\Auth::user()->role_obj->role_name == 'DWP Report Manager' || \Auth::user()->role_obj->role_name == 'Admin')
                                                    @if($section->status == 0) 
                                                        <button type="button" class="btn btn-success pull-right" onclick="getId({{ $section->id }})" data-toggle="modal" data-target="#approve_{{$section->id}}" title="Approve This Section" style="font-size: 10px; margin-left: 5px"><i class="fa fa-check"> Approve</i></button> 
                                                    @endif
