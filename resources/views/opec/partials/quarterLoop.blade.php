...
@for($i=1; $i<=4; $i++)
    <tr>
        ...
        <td  style="border-top: 2px solid #ff0000; border-left: 2px solid #ff0000; border-right: 2px solid #ff0000" align="left" valign=bottom bgcolor="#B8FFE3" sdnum="1033;0;#,##0.00"><font face="Courier New" color="#000000"><br></font> @if(!request()->has('excel')) <input type="number" id="{{$class}}{{$i}}" name="{{$class}}[]" step="0.01" @if(!in_array($class,['refineryStatisticalDiff','statistical_diff'])) value="{{round(@$data[$i-1],3)}}" @else readonly @endif class="{{$class}}"> @else {{round(@$data[$i-1],3)}} @endif</td>
...
<tr>
    ...
    <td id="{{$class}}Total" style="border-bottom: 2px solid #ff0000; border-left: 2px solid #ff0000; border-right: 2px solid #ff0000" align="right" valign=bottom bgcolor="#B8FFE3" sdval="0" sdnum="1033;0;#,##0.00"><font face="Courier New" color="#000000">@if($total>0) {{round($total,3)}} @endif</font></td>
    <td align="left" valign=bottom bgcolor="#BFBFC0" sdnum="1033;0;#,##0.00"><font face="Courier New" color="#000000"><br></font></td>
    <td align="left" valign=bottom bgcolor="#BFBFC0" sdnum="1033;0;#,##0.00"><font face="Courier New" color="#000000"><br></font></td>
    <td align="left" valign=bottom bgcolor="#BFBFC0" sdnum="1033;0;#,##0.00"><font face="Courier New" color="#000000"><br></font></td>
    <td align="left" valign=bottom bgcolor="#BFBFC0" sdnum="1033;0;#,##0.00"><font face="Courier New" color="#000000"><br></font></td>
