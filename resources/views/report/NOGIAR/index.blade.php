                ...
                <ul class="nav nav-pills" role="tablist">
                    @foreach($page as $key=>$page)
                        <li class="nav-item nav-pad">
                            ...
                            onclick="loadUrl('{{url('report/NOGIAR')}}?page={{$key}}&title={{$page}}')" href="#gas" role="tab"> {{$page}} </a>
                        </li>
                    @endforeach
                </ul>

                <!-- Tab panes -->
                <div class="tab-content" style="padding: 25px 0px !important">
                    <div class="tab-pane active p-3" id="gas" role="tabpanel" style="padding: 0px !important">
