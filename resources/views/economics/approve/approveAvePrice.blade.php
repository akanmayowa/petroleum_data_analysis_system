<div class="table-responsive">
    <h5 style="margin-left: 5px; color: #aaa"> Pending Average Price of Nigeria Crude Streams <i style="margin-left: 50px">Total : {{$ave_prices->count()}}</i>  
        <a data-toggle="tooltip" onclick="showmodal('appAVEPmodal')" class="btn btn-primary waves-effect waves-light approve-btn pull-right" title="Approve All Pending Data" style="color: #fff">  <i class="fa fa-check"> </i> Approve Data </a>
    </h5> 
        <table class="table table-striped mb-0 table-responsive" id="">
            <thead>
            <tr style="background-color: #ccc">
                <th>
                    <label style="text-align: left"> <input type="checkbox" class="" id="AVEP_check_all" style="margin-top: 5px;"> </label>
                </th>
                <th>Year</th>
                <th>Stream </th>
...
<script type="text/javascript">
    $(function()
    {
        ...
        $('#AVEP_no_btn').click(function(e)
        {
            $('#appAVEPmodal').modal('hide');
        });      
    });
...
<form id="" action="{{route('notify-custodian-for-approval')}}" method="POST">
    @csrf 
    <div id="appAVEPmodal" class="modal fade" role="dialog" style="margin-top: 10%; z-index: 10000">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="" style="text-align: center!important">
                        <button type="button" name="" id="AVEP_no_btn" class="btn btn-outline-warning waves-effect waves-lightbtn-lg"> Cancel </button>
                        <button type="submit" name="yes_btn" id="AVEP_yes_btn" class="btn btn-info btn-lg">
