    ...
    {{ csrf_field() }}
          ...
          @endphp
           ...
           <div class="form-group row">
                <label for="year_act_pe" class="col-sm-2 col-form-label"> Year </label>
                <div class="col-sm-4">
                    <input type="text" class="form-control" placeholder="Year - YYYY" name="year" id="year_act_pe" value="{{$GAS_ACT->year}}" required="" readonly>
                </div>

                <label for="month_act_pe" class="col-sm-2 col-form-label"> Month </label>
                <div class="col-sm-4">
                    <input type="text" class="form-control" placeholder="Month" name="month" id="month_act_pe" value="{{$GAS_ACT->month}}" readonly>
                </div>
            </div>
...
<script>
    ...
    { 
        ...
        {   
            e.preventDefault();            
            editForm('gasActProdForm', "{{url('/gas')}}", 'edit_gas_act_production');

            displayGasActualProd();
        });


        $('#year_act_pe').datepicker(
        {
            autoclose: true,
