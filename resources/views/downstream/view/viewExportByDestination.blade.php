 ...
 <form id="" action="{{url('/downstream/add_crude_export_destination')}}" method="POST">
          {{ csrf_field() }}
          ...
          <div class="form-group row">
            ...
            <div class="col-sm-11">
                <input type="text" class="form-control" placeholder="Year Of Export" name="year" id="year_dest" value="{{$EXPORT_DEST->year}}" disabled="">
            </div>            
          </div> 
          ...
          <div class="form-group row">
            ...
            <div class="col-sm-5">
                <select class="form-control" name="stream_id" id="stream_id" disabled>
                    @if($one_str) <option value="{{$one_str->id}}"> {{$one_str->stream_name}} </option> @else <option value=""> Select Stream </option> @endif
                </select>
            </div>
           ...
           <div class="form-group row">
            ...
            <div class="col-sm-5">
                <select class="form-control" name="destination" id="destination" disabled>
                    @if($one_cont) <option value="{{$one_cont->id}}"> {{$one_cont->region->region_name}} </option> @else <option value=""> Select Destination (Continent) </option> @endif
                </select>
            </div>
          ...
          <div class="form-group row">
            ...
            <div class="col-sm-11">
                <input type="number" step="0.01" class="form-control" placeholder="Yearly Stream Total" name="stream_total" id="stream_total" disabled value="{{$EXPORT_DEST->stream_total}}">
            </div>
          </div>          
